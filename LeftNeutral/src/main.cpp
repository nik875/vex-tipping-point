...
void autonomous(void) {
 ...
 frontClamp.set(true);
 wait(10, msec);
 Drivetrain.driveFor(reverse, 79, inches, 600, velocityUnits::rpm);
 Drivetrain.turnToHeading(277, degrees);
 Drivetrain.driveFor(reverse, 9, inches, 200, velocityUnits::rpm);
 Drivetrain.driveFor(reverse, 7, inches, 100, velocityUnits::rpm);
 backClamp1.set(true);
 Drivetrain.driveFor(forward, 15, inches, 100, velocityUnits::rpm);
            FourBar.startRotateFor(140, degrees, 140, velocityUnits::rpm);
