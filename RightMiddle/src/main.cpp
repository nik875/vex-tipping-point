...
void autonomous(void) {
 ...
 frontClamp.set(true);
 wait(2, msec);
 Drivetrain.driveFor(reverse, 58.1, inches, 600, velocityUnits::rpm);
 Drivetrain.turnToHeading(306.9, degrees);
 Drivetrain.driveFor(reverse, 38, inches, 200, velocityUnits::rpm);
 wait(5, msec);
 backClamp1.set(true);
